...
with col_main:
    ...
    <div style='display: flex; justify-content: center;'>
        <div style='display: flex; align-items: center; border: 2px solid #ccc; border-radius: 12px; padding: 20px;'>
    ...
    if home_team and away_team:
        match1 = df[(df['HomeTeam'] == home_team) & (df['AwayTeam'] == away_team)]
        match2 = df[(df['HomeTeam'] == away_team) & (df['AwayTeam'] == home_team)]
        ...
        if total_matches > 0:
            ...
            st.warning("⚠️ Belum ada data historis untuk pertandingan ini.")
